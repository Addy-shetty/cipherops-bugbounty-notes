...
cover: >-
  https://images.unsplash.com/photo-1473625247510-8ceb1760943f?crop=entropy&cs=srgb&fm=jpg&ixid=M3wxOTcwMjR8MHwxfHNlYXJjaHw1fHxqb3VybmV5fGVufDB8fHx8MTc3MzcyODY1Mnww&ixlib=rb-4.1.0&q=85
coverY: -526.1705551086083
---
...
Every morning, Alex followed the same routine: fire up Subfinder, run it against the target, get \~100 subdomains, run httpx to check which were live, start testing... and discover that every interesting subdomain had already been found by someone else.

**The breaking point came on a Tuesday.**

Alex had spent six hours on a fintech target, found three XSS vulnerabilities, submitted reports with excitement, and received the dreaded response within hours:
...
> **@jhaddix:** "If you're only using one subdomain enumeration tool, you're missing 70% of the attack surface. Thread 🧵"
...
> "Thank you for this critical finding. The backup server was created during a migration six months ago and accidentally left exposed. Your report prevented a potential data breach affecting millions of customers. Bounty awarded: $8,000."
...
**Lesson 1: Tools Matter** Not all tools are created equal. Amass isn't just "another subdomain finder" - it's a comprehensive attack surface mapping platform.

**Lesson 2: Methodology Beats Luck** The old approach was "run tool, test results." The new approach is "comprehensive reconnaissance, systematic testing, continuous monitoring."

**Lesson 3: The Hidden Gems** The most valuable vulnerabilities aren't on `www.target.com` or `api.target.com`. They're on `backup.target.com`, `dev-old.target.com`, `migration-2023.target.com`.

**Lesson 4: Permutations Are Gold** Companies are messy. They create subdomains with inconsistent naming. Permutation attacks find these inconsistencies.
...
| Feature         | Amass     | Subfinder | Assetfinder | Amass Advantage         |
| --------------- | --------- | --------- | ----------- | ----------------------- |
...
* [Chaos](https://chaos.projectdiscovery.io) - Free for researchers https://cipherops.gitbook.io/bug-bounty-notes/\~/revisions/OFMFgVhvJXTppHDgTUPa/tools/nuclei-the-vulnerability-scanner-that-changed-bug-bounty
